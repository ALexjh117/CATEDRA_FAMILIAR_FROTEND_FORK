  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <div className="flex flex-col items-end">
        ...
        <button aria-label="Cambiar vista (Preview)" title="Cambiar vista (Preview)" onClick={()=>setOpen(o=>!o)} className="w-12 h-12 rounded-full bg-indigo-600 text-white shadow-lg flex items-center justify-center"> 
