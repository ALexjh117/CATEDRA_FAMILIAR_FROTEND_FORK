...
import EquipoDesarrolloPage from './pages/EquipoDesarrolloPage'
...
import AlertasCoordinadorPage from './pages/AlertasCoordinadorPage'

import DashboardAcudientePage from './pages/DashboardAcudientePage'

import OfflineFlowLabPage from './pages/OfflineFlowLabPage'
...
import MisAcudientesPage from './pages/MisAcudientesPage'

import BancoTareasDocentePage from './pages/BancoTareasDocentePage'

import NotasDocentePage from './pages/NotasDocentePage'

import NotaEstudianteDetallePage from './pages/NotaEstudianteDetallePage'
...
import MisTareasEspecialesPage from './pages/MisTareasEspecialesPage'
...
import MisEstudiantesPage from './pages/MisEstudiantesPage'
...
<Route path="/docente/notas" element={
  ...
  <ProtectedRoute allowedRoles={['docente','docente_aula']}>
...
<Route path="/docente/notas/estudiante/:estudianteId" element={

  <ProtectedRoute allowedRoles={['docente','docente_aula']}>

    <NotaEstudianteDetallePage />
          ...
          <Route path="/coordinador/alertas" element={

            <ProtectedRoute allowedRoles={['coordinador', 'rector', 'admin']}>

              <AlertasCoordinadorPage />
          ...
          <Route path="/lab/offline" element={
          ...
          <Route path="/estudiante/tareas-especiales" element={

            <ProtectedRoute allowedRoles={['estudiante']}>

              <MisTareasEspecialesPage />
