...
3. **Cambio Obligatorio de Contraseña** - 1 endpoint
4. **Gestión de Estudiantes con Carga Excel** - 3 endpoints
5. **Gestión de Usuarios** - 4 endpoints CRUD
